...
So, the generated covariates are *alive*, *civil_status*, and *present*. We create these new variables in the *observation* frame:
...
Now the values of *alive*, *civil_status*, and *present* must be filled in.
